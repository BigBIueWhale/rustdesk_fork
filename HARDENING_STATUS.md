...
- **R-S11da/R-S11db/R-S11dc bootstrap-candidate refresh — SOURCE CORRECTION AND FOCUSED
  ...
  the sealed candidate only when rootfs is byte-identical by layer identity and every configuration field except
  that one label is unchanged. Candidate capture reports the newly observed recipe and package identities beside
