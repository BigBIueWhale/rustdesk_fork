...
| Android packaging and cache publication (R-S11fu/R-S11fv/R-S11fz/R-S11cq/R-S11cn/R-S11fy) | The source-side packaging, immutable-cache, extraction, replacement, and recovery contracts remain requirement-owned. All six current Android, Debian, and Windows-helper bootstrap/certified builder archives are locally present and pin-bound. The current test-only x86_64 APK has a real isolated build/install/launch/render baseline, but it was ephemeral and is not a stable-signed or retained APK/AAB. Complete canonical release inputs, stable signing material, cold artifact equality, lifecycle/peer/presentation/device evidence, independent reproduction, and external review remain absent or open. |
...
| Android and iOS | Android has no root IPC boundary and its exported service/component source shape is contained; the exact-current test-only x86_64 APK now has one isolated Android 14 install/launch/resume/framebuffer baseline. That baseline does not exercise the persistent service, task swipe/Force Stop/reopen, reconnect, real peer/session, capture/decode/presentation freshness, background/focus, stale-generation refusal, or bounded resource cleanup, and it is not stable-signed release/device evidence. iOS still has no current package/device result. |
...
- **R-S11br/R-S11e-84 — Android native voice-call capture has exact process-wide owners — SOURCE
  ...
  Exact pushed commit `a2cbbbd27228aa053994a2f65ee075baf7e88f68`, tree
  `b6b1898106eee0a62cfa96dad62f6240c8192e11`, retains the focused executable in the
...
Exact pushed commit `a2cbbbd27228aa053994a2f65ee075baf7e88f68` additionally compiled and executed
