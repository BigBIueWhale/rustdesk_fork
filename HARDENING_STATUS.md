...
| R-S2 FSM collapse · R-S5 `set_raw` seal · R-S9 PRS-at-rest · R-S10 limiter re-key · R-S13 initiator bar · R-S17 host-key pin · R-S18 OS-credential delete | **PARTIAL** | **R-S2 resume paths removed** (`2cf3ad6`, see R-A2); **R-S9 PRS-at-rest** done (`ef8fa72` plaintext-PRS storage + the R-A4 non-empty check). REMAINING: R-S5 set_raw seal (tunnel-tied), R-S10 limiter (the R-P14c hook is in place, wire the counter), R-S13 viewer bar, R-S17/R-S18 — PAKE-downstream / core-logic |
