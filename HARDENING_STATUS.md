...
| R-X1 updater · R-X3 ConfigureUpdate twins · R-X4 trust-anchor/`custom_server` · R-X5 LAN · R-X7 OTP/TOTP · R-X8 terminal · R-X9 Win run-mode/elevation · R-X10 Linux run-mode · R-X11 gtk_sudo · R-X12 Wayland capture · R-X13 uinput/rdp_input · R-X14 os_login PAM | **DEFER-BUILD** | entangled with R-D4 (mediator refactor) / R-B6 (Sciter) / each other, or require semantic reworks (not pure deletion), or `BLOCK-CARGO` for their dep drops (`totp-rs`, `impersonate_system`). Footprints + the de-tangling order (Sciter → mediator → the rest) are mapped in `.claude/ralph-progress.md` |
