...
5. R-R2b lockdown-feature retirement (**DONE** — feature retired, hardening unconditional), the R-S16(d)(ii) SwitchPermission-widener removal, R-R3 audit (fork-bumps), §19 GUI sweep, R-R2 CI prune, smoke-tests (R-B4).
