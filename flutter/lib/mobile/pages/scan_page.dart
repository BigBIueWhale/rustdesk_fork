...
class _ScanPageState extends State<ScanPage> {
  ...
  void _onQRViewCreated(QRViewController controller) {
    ...
    scanSubscription = controller.scannedDataStream.listen((scanData) async {
      ...
      // rustdesk:// deep-link is honored: its parser (urlLinkToCmdArgs) strips any embedded
      // key/password/relay so the URI cannot inject a trust anchor or credential (R-X6, Rust core
      // too), and handleUriLink confirmation-gates the connect. A scan-to-connect-by-ID flow is moot
      // under R-SV5.
