...
def validate(sources: Dict[str, str]) -> None:
    ...
    for token, label in (
        ...
        ('[ "${#git_specs[@]}" -eq 3 ]', "exact Git dependency count"),
    ...
    for token, label in (
        ...
        ("EXPECTED_GIT_DEPENDENCIES = 3", "exact Git dependency count"),
        ...
        ("Pub cache does not contain the exact three locked Git dependencies",
