...
mod tests {
    use super::{
        set_path_permission, sid_string_to_local_alloc_guard, LocalAllocGuard, ResultType,
    };
    use hbb_common::bail;
    use std::{
        fs,
    ...
    use windows::{
        ...
        Win32::{
            Security::{
                ...
                EqualSid as WinEqualSid, GetAce, GetAclInformation, ACCESS_ALLOWED_ACE, ACE_HEADER,
